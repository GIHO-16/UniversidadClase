...
public class Aplicacion {
    public static void main(String[]args){
        ...
        Materia m1 = new MateriaPractica("M01", "Algoritmos Avanzados", 5.0, 4);
        Materia m2 = new MateriaTeorica("M02", "Sistemas Operativos", 4.0, 3);
        Materia m3 = new MateriaPractica("M03", "Inteligencia Artificial", 6.0, 5);
